...
public class PlayerHealth : MonoBehaviour {
	...
	public SoundCollection playerHits;				// Reference to the Scriptable object with the Player screams.
	...
	[HideInInspector]
	public AudioSource playerAudio;					// Reference to the Audio Source of the Enemy.
	...
	private AudioClip playerHitAudio;				// Clip to play when player is hit.
	...
	public void TakeDamage (float damage)
	{
		...
		else 
		{
			...
			playerAudio.clip = playerHits.soundCollection[Random.Range( 0, playerHits.soundCollection.Count)];
			playerAudio.Play ();
		}
